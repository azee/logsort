package ru.greatbit.logsort.mht;
...
//     * @throws Exception
//     */
//    public static String decompress(File mhtFile) throws Exception
//    {
//        BufferedReader reader = null;
//
//        String type = "";
...
//                {
//                    if(buffer != null) {
//                        sb.append(getBufferContent(buffer, encoding));
//                        buffer = null;
//                    }
//
//                    buffer = new StringBuilder();
...
//    }
//
//    private static String getCharSet(String temp)
//    {
//        String t = temp.split("=")[1].trim();
//        return t.substring(1, t.length()-1);
//    }
...
//     * Save the file as per character set and encoding
//     */
//    private static byte[] getBufferContent(StringBuilder buffer, String encoding)
//            throws Exception
//    {
//
//        byte[] content = null;
...
//     * When the save the *.mts file with 'utf-8' encoding then it appends '=EF=BB=BF'</br>
//     */
//    private static byte[] getQuotedPrintableString(StringBuilder buffer)
//    {
//        String temp = buffer.toString().replaceAll(UTF8_BOM, "").replaceAll("=\n", "");
//        return temp.getBytes();
//    }
...
//     * Although system dependent..it works well
//     */
//    private static byte[] getBase64EncodedString(StringBuilder buffer) throws Exception {
//        return new BASE64Decoder().decodeBuffer(buffer.toString());
//    }
//
//
...
//    }
//
//    private static String getEncoding(String line){
//        return splitUsingColonSpace(line);
//    }
//
//    private static String splitUsingColonSpace(String line) {
//        return line.split(":\\s*")[1].replaceAll(";", "");
//    }
//
//    /**
//     * Gives you the boundary string
//     */
//    private static String getBoundary(BufferedReader reader) throws Exception
//    {
//        String line = null;
//
//        while((line = reader.readLine()) != null)
